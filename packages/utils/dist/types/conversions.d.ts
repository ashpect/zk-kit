 ...
 */
export declare function bigIntToHexadecimal(value: bigint): string;
/**
 ...
 */
export declare function hexadecimalToBigInt(value: string): bigint;
/**
 ...
 */
export declare function beBufferToBigInt(value: Buffer | Uint8Array): bigint;
/**
 ...
 */
export declare function leBufferToBigInt(value: Buffer | Uint8Array): bigint;
/**
 * Converts a buffer to a bigint. Alias for beBufferToBigInt.
 * @param value The buffer to convert.
 * @returns The bigint representation of the buffer's contents.
 */
export declare function bufferToBigInt(value: Buffer | Uint8Array): bigint;
/**
 ...
 */
export declare function beBigIntToBuffer(value: bigint, size?: number): Buffer;
/**
 * Converts a bigint to a buffer and fills with zeros if a valid
 * size (i.e. number of bytes) is specified. If the size is not defined,
 * it gets the size from the given bigint. If the specified size is smaller than
 ...
 */
export declare function leBigIntToBuffer(value: bigint, size?: number): Buffer;
/**
 ...
 */
export declare function bigNumberishToBigInt(value: BigNumberish): bigint;
/**
 ...
 */
export declare function bigNumberishToBuffer(value: BigNumberish): Buffer;
/**
 ...
 */
export declare function hexadecimalToBuffer(value: string): Buffer;
/**
 ...
 */
export declare function bufferToHexadecimal(value: Buffer | Uint8Array): string;
/**
 ...
 */
export declare function bufferToBase64(value: Buffer | Uint8Array): string;
/**
 ...
 * @returns The converted base64 string.
 */
export declare function textToBase64(value: string): string;
/**
 ...
 */
export declare function base64ToText(value: string): string;
