...
*/
var zkKitLazytower = (function (exports, poseidonLite) {
    'use strict';
    ...
    const defaultHash = (a, b) => poseidonLite.poseidon2([a, b]);
    /**
    ...
    exports.LazyTowerHashChainProofBuilder = LazyTowerHashChainProofBuilder;
